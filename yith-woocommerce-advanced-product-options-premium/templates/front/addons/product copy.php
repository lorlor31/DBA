	...
	if ( 'product' === $price_method ) {
		...
		// : '';
			if ($_product->get_sale_price()) {
			 '<small class="option-price"  style="text-decoration:line-through; font-size:16px color :#6F6F6F;font-weight: 700; margin : 7px 0 5px 0">'. wc_price(number_format($_product->get_regular_price(), 2, '.', '')) . '</small> </br> '.'<small class="option-price" style="color:#C92F00; margin : 7px 0 5px 0;"> '. $_product->get_sale_price() . '</small>' 
			else {
			'<small class="option-price"  style="font-size:16px color :#6F6F6F;font-weight: 700; margin : 7px 0 5px 0">'. wc_price(number_format($_product->get_regular_price(), 2, '.', '')) . ' </br> '. '</small>';
		else '';
