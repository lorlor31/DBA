...
<div class="order_info" style="margin-top:15px;">
    <h1>Proforma</h1>
    <h2><?= str_replace( 'DWAP', 'PFAP', apply_filters( 'ywraq_quote_number', $order_id ) ) ?></h2>
    <span>Date de la proforma : <?= $order_date ?></span><br>
</div>
<div class="info">
   ...
   <?php if (($formatted_address_form !== $shipping_address) && ('' !== $shipping_address)) {
    ...
    <?php if ($order_message != ''): ?>
        <div class="note_livraison">
            <span class="label">Note client coucou :</span>
