...
<?php
/* Block page Brand VINCO */
$current_url = $_SERVER['REQUEST_URI'];
if (strpos($current_url, '/brand/vinco/') !== false) {
	echo do_shortcode('[block id="74718"]'); 
}
...
$display_type = get_woocommerce_term_meta($current_category_id, 'display_type', true);
// Supposons que vous voulez afficher <hr> si 'display_type' est configuré pour ne PAS afficher les sous-catégories
