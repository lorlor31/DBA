...
//		$this->add_section_opportunities();
	...
	private function inject_developer_banner() {
		...
		<div class="pmw dev-banner">
			...
			<?php if (!wpm_fs()->can_use_premium_code__premium_only()) : ?>
				<div
						class="text center"
						id="divTooltip"
...
//		self::get_documentation_html_by_key('pinterest_enhanced_match');
	...
	public function option_html_shop_order_total_logic() {
		...
		<?php if (wpm_fs()->can_use_premium_code__premium_only() || '2' === $this->options['shop']['order_total_logic'] || $this->options['general']['pro_version_demo']) : ?>
			<br>
			<label>
...
//		self::get_documentation_html_by_key('google_consent_regions');
	...
	private static function html_pro_feature() {
		if (!wpm_fs()->can_use_premium_code__premium_only() && Options::get_options()['general']['pro_version_demo']) {
//            if (1===1) {
