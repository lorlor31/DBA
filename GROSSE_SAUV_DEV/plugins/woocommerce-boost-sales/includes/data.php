...
class VI_WBOOSTSALES_Data {
	...
	public function __construct() {
		...
		$this->default = array(
			...
			'frequently_product_exclude_products'          => array(),
			'frequently_product_exclude_categories'        => array(),
			'frequently_product_hide_if_added'             => 1,
			'frequently_product_source'                    => 'cross_sells',
			...
			'frequently_product_only_select_1'             => 0,
			'frequently_product_item_link'                 => 'new_tab',
			'upsells_select_option_template'               => 'default',
		);
	...
	public static function convert_price_to_float( $price ) {
		...
		return floatval( str_replace( array( $args['thousand_separator'], $args['decimal_separator'] ), [ '', '.' ], $price ) );
	}
