<?php
/*
 * The file is included from _assets-hardcoded-list.php, and it's relevant only for the hardcoded assets (non-enqueued)
*/
    ...
    <td style="position: relative;" data-wpacu-row-status="<?php echo esc_attr($dataRowStatusAttr); ?>">
        ...
        if (isset($data['row']['obj']->src) && trim($data['row']['obj']->src)) {
            ...
            <div class="wpacu-hardcoded-code-area">
                <?php
                if ($tagBelongsTo = HardcodedAssets::belongsTo($data['row']['obj']->tag_output)) {
