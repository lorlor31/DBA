...
class Settings
{
    ...
    public function adminInit()
    {
        ...
        // "Settings" -- "Plugin Usage Preferences" -- "Prevent specific features from Asset CleanUp Pro from triggering on specific pages" -- "Add New Rule"
	...
	public function filterSettings($settings)
	{
        ...
        // -- "Prevent specific features from Asset CleanUp Pro from triggering on specific pages"
    ...
    public static function generateNewRuleNoFeatureAreaRow($data, $setValues = array('pattern' => '', 'list' => array()))
    {
        ...
        $allFeaturesSelectOptions = array(
