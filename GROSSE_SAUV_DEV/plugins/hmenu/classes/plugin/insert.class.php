<?php
    ...
    class hmenu_class_insert extends hmenu_backend
    {
        ...
        #INSERT MENU
        public function hmenu_insert_menu()
        {
            ...
            $status = true;
            if ($hmenu_helper->hmenu_checkString($form_data['add_new_menu'])) {
                $menu_name = true;
            } else {
                $menu_name = false;
                $status = false;
            ...
            if ($status) {
                ...
                $this->hmenu_menu_sql_inject($wpdb->insert_id);
                exit;
            }
        ...
        public function hmenu_menu_sql_inject($menu_id)
        {
            ...
            $wpdb->query(
                "
					...
					(
						...
						`menuBarbuttonColor`,
						`menuBarMobileIcon`,
						`menuBarMobileIconPaddingLeft`,
						`menuBarMobileIconPaddingRight`
					) VALUES (
						'".$menu_id."', 						
						'#FFFFFF',
						'0',
