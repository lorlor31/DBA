...
if ( ! class_exists( 'YITH_YWRAQ_Send_Email_Request_Quote' ) ) {
	...
	class YITH_YWRAQ_Send_Email_Request_Quote extends WC_Email {
		...
		public function trigger( $args ) {
			...
			// quote checkout.
			$this->raq['content_type'] = isset( $args['from_checkout'] ) || ( get_option( 'ywraq_enable_order_creation', 'yes' ) === 'yes' && isset( $args['sent_from_cart'] ) && $args['sent_from_cart'] ) ? 'order_items' : 'raq_content';
		...
		public function init_form_fields() {
			$this->form_fields = apply_filters(
				'yith_ywraq_send_email_request_quote_form_fields',
				array(
					'enabled'           => array(
