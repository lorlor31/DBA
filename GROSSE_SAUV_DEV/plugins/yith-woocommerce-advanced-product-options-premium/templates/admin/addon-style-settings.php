		...
		<div class="field">
			...
			yith_plugin_fw_get_field(
				array(
					...
					'type'  => 'onoff',
					'value' => $addon->get_setting( 'custom_style', 'yes', false ),
				),
				true
			);
			?>
		...
		<div class="field">
			...
			yith_plugin_fw_get_field(
				array(
					...
					'type'    => 'select',
					'class'   => 'wc-enhanced-select',
					'value'   => $addon->get_setting( 'label_content_align', 'left', false ),
					'options' => array(
		...
		<div class="field">
			...
			yith_plugin_fw_get_field(
				array(
					...
					'type'  => 'onoff',
					'value' => $addon->get_setting( 'image_equal_height', 'no', false ),
				),
				true
			);
			?>
		...
		<div class="field">
			...
			yith_plugin_fw_get_field(
				array(
					...
					'type'    => 'select',
					'class'   => 'wc-enhanced-select',
					'value'   => $addon->get_setting( 'label_position', 'inside', false ),
					'options' => array(
		...
		<div class="field">
			...
			yith_plugin_fw_get_field(
				array(
					...
					'type'    => 'select',
					'class'   => 'wc-enhanced-select',
					'value'   => $addon->get_setting( 'description_position', 'outside', false ),
					'options' => array(
						'inside'  => __( 'Inside borders', 'yith-woocommerce-product-add-ons' ),
						'outside' => __( 'Outside borders', 'yith-woocommerce-product-add-ons' ),
					),
