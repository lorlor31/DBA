...
if ( !function_exists('etheme_fpcontent') ) {
	echo esc_html__('Activate Legenda Core plugin', 'legenda');
	return;
}

if ( is_dir( get_home_path() . '/../theme/plugins/envato_setup/content/' ) ) {
	etheme_fpcontent( get_home_path() . '/../theme/plugins/envato_setup/content/default.json' , json_encode( $default_content ) );
	etheme_fpcontent( get_home_path() . '/../theme/plugins/envato_setup/content/widget_positions.json' , json_encode( $widget_positions ) );
	etheme_fpcontent( get_home_path() . '/../theme/plugins/envato_setup/content/widget_options.json' , json_encode( $widget_options ) );
	etheme_fpcontent( get_home_path() . '/../theme/plugins/envato_setup/content/menu.json' , json_encode( $menu_ids ) );
	etheme_fpcontent( get_home_path() . '/../theme/plugins/envato_setup/content/options.json' , json_encode( $my_options ) );
}
