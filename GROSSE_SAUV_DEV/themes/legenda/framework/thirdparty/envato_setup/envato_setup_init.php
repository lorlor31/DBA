				...
				public function theme_setup_wizard_content($content){
					if($this->is_possible_upgrade()){
						array_unshift_assoc($content,'upgrade',array(
							'title' => __( 'Upgrade', 'legenda' ),
							'description' => __( 'Upgrade Content and Settings', 'legenda' ),
							'pending' => __( 'Pending.', 'legenda' ),
							'installing' => __( 'Installing Updates.', 'legenda' ),
							'success' => __( 'Success.', 'legenda' ),
