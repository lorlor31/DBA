...
error_log('$product_price_label est ' . $product_price_label);
error_log('$total_options_label est ' . $total_options_label);
error_log('$price_suffix est ' . $price_suffix);
error_log('$price_display_suffix est ' . $price_display_suffix);
