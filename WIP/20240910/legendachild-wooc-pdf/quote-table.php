							...
							<tr>
								...
								<td colspan="4">
									...
									<div id="addinfo_attribu">
										...
										// 		$meta_key_to_update = $meta->key ;
										// 		$meta_value = str_replace('(+', '(inclus ', $meta_value);												// Si tu veux arrêter après la première occurrence, utilise un break
										// 		$item->update_meta_data( $meta_key_to_update, $meta_value );
