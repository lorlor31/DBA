...
! defined( 'YITH_WAPO_VERSION' ) && define( 'YITH_WAPO_VERSION', '4.17.1' );
! defined( 'YITH_WAPO_SCRIPT_VERSION' ) && define( 'YITH_WAPO_SCRIPT_VERSION', '4.17.0' );
...
yith_deactivate_plugins( 'YITH_WAPO_FREE_INIT', plugin_basename( __FILE__ ) );
