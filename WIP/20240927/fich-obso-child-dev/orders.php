						...
						<?php endif; ?>
							...
							<?php elseif ( 'order-actions' === $column_id ) : ?>
								...
								if ( $order->get_status() === 'completed' ) {
									$db_factures = new VosfacturesDatabase();
									$invoice  = $db_factures->get_last_invoice( $order->get_id() );
									echo '<a target="_blank" class="button" href="'. esc_html( $invoice->view_url ).'.pdf" class="button-facture">Votre Facture</a>';
