		...
		<div class="field">
			...
			yith_plugin_fw_get_field(
				array(
					...
					'type'    => 'radio',
					'value'   => $addon->get_setting( 'selection_type', 'single', false ),
					'options' => array(
			...
			<div class="field">
				...
				yith_plugin_fw_get_field(
					array(
						...
						'class' => 'enabler',
						'type'  => 'onoff',
						'value' => $addon->get_setting( 'first_options_selected', 'no', false ),
					),
					true
				);
				?>
			...
			<div class="field">
				...
				yith_plugin_fw_get_field(
					array(
						...
						'type'  => 'number',
						'value' => $addon->get_setting( 'first_free_options', 0, false ),
					),
					true
				);
				?>
			...
			<div class="field">
				...
				yith_plugin_fw_get_field(
					array(
						...
						'class' => 'enabler',
						'type'  => 'onoff',
						'value' => $addon->get_setting( 'enable_min_max', 'no', false ),
					),
					true
				);
				?>
			...
			<div class="field">
				...
				yith_plugin_fw_get_field(
					array(
						...
						'class' => 'enabler',
						'type'  => 'onoff',
						'value' => $addon->get_setting( 'sell_individually', 'no', false ),
					),
					true
				);
				?>
