		...
		<div class="field">
			...
			yith_plugin_fw_get_field(
				array(
					...
					'type'  => 'onoff',
					'value' => $addon->get_setting( 'show_image', 'no', false ),
				),
				true
			);
			?>
			...
			<div class="field">
				...
				yith_plugin_fw_get_field(
					array(
						...
						'value'   => $addon->get_setting( 'image_replacement', 'no', false ),
						'options' => array(
				...
				<div class="field">
					...
					yith_plugin_fw_get_field(
						array(
							...
							'type'    => 'select',
							'class'   => 'wc-enhanced-select',
							'value'   => $addon->get_setting( 'options_images_position', 'above', false ),
							'options' => array(
		...
		<div class="field">
			...
			yith_plugin_fw_get_field(
				array(
					...
					'type'    => 'select',
					'class'   => 'wc-enhanced-select',
					'value'   => $addon->get_setting( 'show_as_toggle', 'no', false ),
					'options' => array(
			...
			<div class="field">
				...
				yith_plugin_fw_get_field(
					array(
						...
						'type'  => 'onoff',
						'value' => $addon->get_setting( 'hide_products_prices', 'no', false ),
					),
					true
				);
				?>
			...
			<div class="field">
				...
				yith_plugin_fw_get_field(
					array(
						...
						'name'  => 'addon_show_sku',
						'type'  => 'onoff',
						'value' => $addon->get_setting( 'show_sku', 'no', false ),
					),
					true
				);
				?>
			...
			<div class="field">
				...
				yith_plugin_fw_get_field(
					array(
						...
						'type'  => 'onoff',
						'value' => $addon->get_setting( 'show_stock', 'no', false ),
					),
					true
				);
				?>
			...
			<div class="field">
				...
				yith_plugin_fw_get_field(
					array(
						...
						'type'  => 'onoff',
						'value' => $addon->get_setting( 'show_add_to_cart', 'no', false ),
					),
					true
				);
				?>
			...
			<div class="field">
				...
				yith_plugin_fw_get_field(
					array(
						...
						'type'  => 'onoff',
						'value' => $addon->get_setting( 'show_quantity', 'no', false ),
					),
					true
				);
				?>
			...
			<div class="field">
				...
				yith_plugin_fw_get_field(
					array(
						...
						'type'  => 'onoff',
						'value' => $addon->get_setting( 'hide_options_images', 'no', false ),
					),
					true
				);
				?>
			...
			<div class="field">
				...
				yith_plugin_fw_get_field(
					array(
						...
						'type'  => 'onoff',
						'value' => $addon->get_setting( 'hide_options_label', 'no', false ),
					),
					true
				);
				?>
			...
			<div class="field">
				...
				yith_plugin_fw_get_field(
					array(
						...
						'type'  => 'onoff',
						'value' => $addon->get_setting( 'hide_options_prices', 'no', false ),
					),
					true
				);
				?>
		...
		<div class="field">
			...
			yith_plugin_fw_get_field(
				array(
					...
					'type'  => 'onoff',
					'value' => $addon->get_setting( 'show_in_a_grid', 'no', false ),
				),
				true
			);
			?>
		...
		<div class="field">
			...
			yith_plugin_fw_get_field(
				array(
					...
					'type'  => 'onoff',
					'value' => $addon->get_setting( 'show_quantity_selector', 'no', false ),
				),
				true
			);
			?>
