...
<?php // if ( is_front_page() || is_product_category() || is_product() || is_cart() || is_checkout() ) : ?>
<!-- 
<script>
...
<?php // endif; ?>
        ...
        <div style="border:3px solid #F29806;justify-content:space-between;align-items:center;" class="banner-container">
            <div style="flex:1;" class="banner-left"></div>
            <div style="flex:0 0 auto;margin: 0 auto;display:flex;justify-content:center;align-items:center;" class="banner-middle">
                <p style="font-weight:bold;font-size:16px;display:inline;margin-right:20px;margin-bottom:0;color:#000;">
                    FERMETURE 
                    <span style="color:#F29806;font-weight:900;">ANNUELLE</span>
                </p>
                <span style="color:#000;margin-right:10px;font-weight: bold;font-size: 14px;line-height:30px;" class="star">★</span>
                <span style="color:#000;margin-right:10px;font-weight: bold;font-size: 14px;line-height:30px;" class="star">★</span>
                <span style="color:#000;margin-right:20px;font-weight: bold;font-size: 14px;line-height:30px;" class="star">★</span>
                <p style="font-weight:bold;font-size:16px;display:inline;margin-right:20px;margin-bottom:0;color:#000;">
                    <span style="color:#F29806;font-weight:900;">du 12 au 16 Août</span>
                </p>
                <span style="color:#000;margin-right:10px;font-weight: bold;font-size: 14px;line-height:30px;" class="star">★</span>
                <span style="color:#000;margin-right:10px;font-weight: bold;font-size: 14px;line-height:30px;" class="star">★</span>
                <span style="color:#000;margin-right:20px;font-weight: bold;font-size: 14px;line-height:30px;" class="star">★</span>
                <p style="font-weight:bold;font-size:16px;display:inline;margin-right:0px;margin-bottom:0;color:#000;">
                    Réouverture le <span style="color:#F29806;font-weight:900;">19 Août</span>
                </p>
            </div>
            <div style="flex:1;" class="banner-right"></div>
		    <div style="max-width:1000px;margin:auto;text-align:center;">Chers clients, nous prenons une petite pause estivale pour recharger nos batteries et revenir encore plus en forme ! Pendant cette semaine, notre site reste ouvert pour vos commandes, mais leur traitement reprendra dès le 19 août.<br><b style="color:#F29806;">Merci de votre compréhension et bonnes vacances à tous ! </b>
    </div>
        </div>
