            ...
            <div class="field-wrap">
                ...
                <div class="field">
                    ...
                    if ( ! empty( $existing_columns ) ) {
                        ...
                        <?php
                        foreach( $should_exists as $column_n ) {
                            $column_name = $column_n;
                            if ( in_array( $column_n, $new_columns ) ) {
                                $column_name = '<b>' . $column_n . '</b>';
                            }
                            ?>

                            <div style="display: flex; flex-direction: column; align-items: center;">
                                <span style="font-size: 15px;"><?php echo wp_kses_post( $column_name ); ?></span>
                                <span><?php echo in_array( $column_n, $existing_columns ) ? '<span style="color: forestgreen">exists</span>' : '<span style="color: #c92c2c">no exists</span>'; ?></span>
                            </div>
