    ...
    <table class="quote-table" cellspacing="0" cellpadding="6" style="width:100%;" border="0">
        ...
        if( ! empty( $items ) ):
			foreach( $shipping_methods as $shipping_method ):
				$max_delai = 0;
				$margin = $count < sizeof($shipping_methods) ? 'margin-bottom:10px;' : '';
				...
				?>
				<tr style="<?php echo $margin ?>"> // Ligne Description Shipping methode
					<td colspan="6">
						<?php 
				...
				<tr>
					<td style="text-align:center;font-weight:bold;">Produit</td>
					...
					foreach( $items as $item ):
						...
						if ( strpos( $shipping_item, $item->get_name() ) !== false ):
							...
							$image_tag = '<img src="' . $image_dir . '" width="50px" height="50px">';
							...
							<tr>
								...
								<td style="text-align:left;padding: 0!important;margin:0!important;">
