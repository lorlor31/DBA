...
class WC_Dropshipping_Checkout {
	...
	public function init() {
		...
		// Modif Nico
		add_action( 'woocommerce_order_item_meta_start', array( $this, 'wc_email_after_order_table' ), 10, 3 );
		// Modif Nico
		add_action( 'woocommerce_order_item_meta_end', array( $this, 'product_shipping_details' ), 10, 3 );
	}
...
//Modif Nico
	public function wc_email_after_order_table( $item_id, $item, $order) {
...
//Modif Nico 
	public function product_shipping_details( $item_id, $item, $order ) {
