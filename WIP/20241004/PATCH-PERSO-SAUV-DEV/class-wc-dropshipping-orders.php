...
class WC_Dropshipping_Orders {
	 ...
	 */
	// Modif Nico pour update Version précédente : cette fonction était commentée et différente 
	...
	// Modif Nico pour update Version précédente :
	// cette fonction n'était pas commentée  
	...
	public function get_packingslip_html( $order_info, $supplier_info, $callfrom = false ) {
		...
		if ( $order->get_status() == 'completed' ) {
			...
			//modif attention c'était un PHP avant
