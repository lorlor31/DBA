...
<!-- Rajouté -->
			<div id="contidniko" class="content <?php echo $content_span; ?>">
				...
				if (strpos($current_url, '/brand/vinco/') !== false) {
					echo '<div>Votre contenu spécifique pour la page Vinco</div>';
				}?>
				<!--  -->
				...
				<?php if (woocommerce_product_loop()) : ?>
					...
					<?php if (etheme_get_option('category_description_position') == "under") {
						do_action('woocommerce_archive_description');
					} ?>
...
<!-- id rajouté  -->
			<?php if ($position == 'right'): ?>
				<div id="sbaridniko" class="<?php echo esc_attr($sidebar_span); ?> sidebar sidebar-right">
					<?php do_action('woocommerce_sidebar'); ?>
				</div>
			<?php endif; ?>
		</div>
