			...
			<div class="content <?php echo $content_span; ?>">
				<?php if(have_posts()): while(have_posts()) : the_post(); ?>
					...
					<article <?php post_class('blog-post post-single'); ?> id="post-<?php the_ID(); ?>" >
                        ...
                        <h4 class="post-date">Le <?php echo get_the_date('j F Y'); ?> par <?php echo get_the_author_meta('display_name') ?></h4>
						...
						<?php if(etheme_get_option('posts_links')): ?>
							<div class="row-fluid post-next-prev">
								<div class="span6">coucou<?php previous_post_link() ?></div>
				...
				<!-- Begin Comment<?php comments_template('', true); ?>-->
