...
4.17.0 - Released on 13 September 2024

* Fix: add-on type number calculation
* Fix: attribute name in add-on type Product
* Fix: price calculation on the cart/checkout pages

4.17.0 - Released on 11 September 2024

* New: support for WooCommerce 9.3
* Tweak: disable current day at certain time
* Tweak: print template script only if the product has add-ons type file
* Update: YITH plugin framework
* Fix: allow free sale price
* Fix: wrong price shown in case of VAT suffix/prefix
* Dev: new filter 'yith_wapo_should_replace_product_price'
