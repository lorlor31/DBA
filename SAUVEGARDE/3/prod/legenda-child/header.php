...
<a href="https://www.armoireplus.fr/bon-plan/" style="text-decoration:none;"><div style="border:3px solid #f11022;height:30px;display:flex;justify-content:space-between;align-items:center;" class="banner-container">
	...
	<p style="font-weight:bold;font-size:16px;display:inline;margin-right:20px;margin-bottom:0;color:#000;">OFFRES SPECIALES DE RENTREE 
		<span style="color:#f11022;font-weight:900;"></span>
	</p>
	<span style="color:#f11022;margin-right:10px;font-weight: bold;font-size: 14px;line-height:30px;" class="star">★</span>
	<span style="color:#f11022;margin-right:10px;font-weight: bold;font-size: 14px;line-height:30px;" class="star">★</span>
	<span style="color:#f11022;margin-right:20px;font-weight: bold;font-size: 14px;line-height:30px;" class="star">★</span>
	<p style="font-weight:bold;font-size:16px;display:inline;margin-right:20px;margin-bottom:0;color:#000;">
		<span style="color:#f11022;font-weight:900;">Prix imbattables</span>
		<span id="hide-mobile">sur nos armoires et nos vestiaires</span>
	</p>
	<span style="color:#f11022;margin-right:10px;font-weight: bold;font-size: 14px;line-height:30px;" class="star">★</span>
	<span style="color:#f11022;margin-right:10px;font-weight: bold;font-size: 14px;line-height:30px;" class="star">★</span>
	<span style="color:#f11022;margin-right:20px;font-weight: bold;font-size: 14px;line-height:30px;" class="star">★</span>
	<p style="font-weight:bold;font-size:16px;display:inline;margin-right:0px;margin-bottom:0;color:#000;" class="star">Jusqu'au <span style="color:#f11022;font-weight:900;">30 Septembre</span>
	</p>
	</div>
