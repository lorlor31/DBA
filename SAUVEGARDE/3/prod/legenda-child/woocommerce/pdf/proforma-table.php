...
<div class="info-supp" style="font-size:7pt;margin-top:25px;">
    <h1 style="font-size:11pt;">Modes de paiement acceptés</h1><br>
    <p>En dehors des règlements par Paiements Fractionnés ou Mandat Administratif, toute commande doit être réglée en totalité pour être mise en préparation.</p><br>
    <h2 style="font-size:9pt;color:#b20718;">Paiement par Virement Bancaire</h2><br>
    <p>
        Effectuez le paiement directement depuis votre compte bancaire. Veuillez utiliser l’identifiant de votre commande comme référence du paiement.<br>
        Afin de réaliser votre virement vous trouverez notre RIB en pièce jointe du mail. Votre commande sera traitée à réceptionde votre règlement.
    </p><br><br>
    <h2 style="font-size:9pt;color:#b20718;">Paiement par Chèque</h2><br>
    <p>
        Votre commande sera traitée à réception de votre règlement.<br><br>
        <div style="width:70%;margin:0 auto;text-align:center;">
            Veuillez nous envoyer votre chèque à l’ordre de <b>"Armoire PLUS"</b> à l’adresse suivante : <b>9 ch de Rebel - 31180 Castelmaurou (FRANCE)</b>
        </div>
    </p>
    <br><br>
...
<?php endif ?>
<hr style="margin:50px 0; color:#ffffff;">
    <p>
        <b>Clause de réserve de propriété :</b> De convention express nous nous réservons la propriété des marchandises fournies jusqu'au dernier jour de leur parfait paiement, conformément à la loi n° 80335 du 12 Mai 1980.<br><br>
        <b>Conditions de règlement à terme :</b> En cas de retard de paiement, indemnité forfaitaire légale pour frais de recouvrement : 40,00€ (montant pouvait faire l'objet d'une majoration selon nos CGV), pénalités de retards au taux directeur de la BCE majoré de 10%.
    </p>
</div>
