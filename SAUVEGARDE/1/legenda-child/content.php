...
<article <?php post_class($postClass); ?> id="post-<?php the_ID(); ?>" >
	<div>
		...
		<?php if($post_format != 'quote'): ?>
			...
			<h2 class="post_title_h2 entry-title"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h2>
        ...
        <div class="post-description entry-content">
           <?php the_excerpt(); ?>
            <a href="<?php the_permalink(); ?>" class="more-link"><span class="button right read-more"><?php _e('Read More', 'legenda'); ?></span></a>
        </div>
