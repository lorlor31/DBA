...
class YITH_YWRAQ_Session extends WC_Session {
	 ...
	 */
	private $_session_expiring; //phpcs:ignore
	 ...
	 */
	private $_session_expiration; //phpcs:ignore
	 ...
	 * @var $_has_cookie
	 */
	private $_has_cookie = false; //phpcs:ignore
	...
	public function cleanup_sessions() {
		...
		if ( ! defined( 'WP_SETUP_CONFIG' ) && ! defined( 'WP_INSTALLING' ) ) {
			...
			$wc_session_expires = $wpdb->get_col( "SELECT option_name FROM $wpdb->options WHERE option_name LIKE '\_yith_ywraq\_session\_expires\_%' AND option_value < '$now'" ); //phpcs:ignore
