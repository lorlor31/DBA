...
$desc_tip = sprintf(
	'%s <ul><li>%s</li><li>%s</li><li>%s</li><li>%s</li><li>%s</li><li>%s</li><li>%s</li><li>%s</li><li>%s</li><li>%s </li></ul>',
...
$desc_quote = sprintf(
	'<span class="description">%s<br/>%s <a href="%s" target="_blank">%s</a> %s </span>',
