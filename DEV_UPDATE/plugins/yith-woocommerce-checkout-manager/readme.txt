...
=== Version 1.43.0 === Released on 16 September 2024

* New: support for WooCommerce 9.3
* Update: YITH plugin framework
* Fix: sortable fields not working

=== Version 1.42.0 === Released on 14 August 2024

* New: support for WooCommerce 9.2
* Update: YITH plugin framework
* Fix: error occurring if the billing state is not required
* Dev: new filter 'ywccp_email_additional_field_list'

=== Version 1.41.0 === Released on 14 July 2024

* New: support for WordPress 6.6
* New: support for WooCommerce 9.1
* Update: YITH plugin framework

=== Version 1.40.0 === Released on 26 Jun 2024

* New: support for WooCommerce 9.0
* Update: YITH plugin framework
* Fix: set required not working on billing company field

=== Version 1.39.0 === Released on 21 May 2024

* New: support for WooCommerce 8.9
* Update: YITH plugin framework

=== Version 1.38.0 === Released on 22 Apr 2024

* New: support for WooCommerce 8.8
* Update: YITH plugin framework

=== Version 1.37.0 === Released on 27 Mar 2024
