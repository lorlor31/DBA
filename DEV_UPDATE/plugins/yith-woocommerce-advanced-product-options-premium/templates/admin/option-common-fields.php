		...
		<?php if ( 'color' === $addon_type ) : ?>
			...
			<div class="field-wrap">
				...
				<div class="field color-show-as">
					<?php
					$option_color_type = $addon->get_option( 'color_type', $x, 'single', false );
					yith_plugin_fw_get_field(
						array(
							...
							'options' => array(
								'single' => __( 'Single color swatch', 'yith-woocommerce-product-add-ons' ),
				...
				<div class="field">
					...
					yith_plugin_fw_get_field(
						array(
							...
							'alpha_enabled' => true,
							'default'       => '#AA0000',
							'value'         => $addon->get_option( 'color_b', $x, '#AA0000', false ),
						),
						true
					);
					?>
...
<?php else : ?>
	...
	?>
	<input type="hidden" name="options[label][]" class="yith-wapo-product-addon-label" value="<?php echo $product_addon_label ?>">
	<!-- End option field -->
