...
<div class="categoryStarsMain steavisgarantisStar">
    <div class="categoryStars">
			<span></span>
			<div class="animate" style="width:<?php echo $ratings['average'] / 5 *100?>%;overflow:hidden;height:30px !important;position:relative;">
    ...
    <div class="categoryStarsStr"><?php echo sprintf( _n( '%s review', '%s reviews', $reviews_query->found_posts, 'woo-guaranteed-reviews-company' ), $reviews_query->found_posts ); ?></div>
</div>