...
class WCCT_Input_Html_General_All_Posts_cats {
	public function __construct() {
		// vars
		$this->type = 'Html_General_All_Posts_cats';
	...
	public function render( $field, $value = null ) {
		_e( 'Campaign would render on All Pots Category Pages.', 'finale-woocommerce-sales-countdown-timer-discount-plugin' );
	}

}

class WCCT_Input_Html_General_All_Posts_Tags {
	public function __construct() {
		// vars
		$this->type = 'Html_General_All_Posts_Tags';
	...
	public function render( $field, $value = null ) {
		_e( 'Campaign would render on All Posts Tag Pages.', 'finale-woocommerce-sales-countdown-timer-discount-plugin' );
	}
