...
<div class="fields">
		...
		<div class="field">
			...
			yith_plugin_fw_get_field(
				array(
					...
					'type'  => 'onoff',
					'value' => $addon->get_option( 'show_time_selector', $x, '', false ),
				),
				true
			);
			?>
	...
	<!-- Option field -->
	<div class="field-wrap enabled-by-option-show-time-selector-<?php echo esc_attr( $x ); ?> addon-field-grid" style="display: none;">
		...
		<div class="field">
			...
			yith_plugin_fw_get_field(
				array(
					...
					'type'  => 'onoff',
					'value' => $addon->get_option( 'enable_time_slots', $x, '', false ),
				),
				true
			);
			?>
	...
	<!-- Option field -->
	<div class="field-wrap enabled-by-option-enable-time-slots-<?php echo esc_attr( $x ); ?> addon-field-grid" style="display: none;">
		<label>
            <?php
            // translators: Add-on type date option
            echo esc_html__( 'Rule type', 'yith-woocommerce-product-add-ons' );
