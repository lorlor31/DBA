<?php 
	class Etheme_Flickr_Widget extends WP_Widget {
	    ...
	    {
		    if (etheme_admin_widget_preview(esc_html__('8theme - Flickr Photos', 'woopress-core')) !== false) return;
	        extract($args);

	        $title = apply_filters('widget_title', empty( $instance['title'] ) ? __('Flickr', 'legenda-core') : $instance['title'], $instance, $this->id_base);
